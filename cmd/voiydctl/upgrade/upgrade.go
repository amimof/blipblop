...
voiydctl upgrade prod-node-01

# Upgrade two nodes by name to specific version
voiydctl upgrade node1 node2 --version v0.0.8
	
# Upgrade all nodes with label voiyd/arch==amd64 to latest version
voiydctl upgrade -l voiyd/arch=amd64
`,
