...
import (
	...
	volumectrl "github.com/amimof/voiyd/pkg/controller/volume"
)
...
func init() {
	...
	pflag.StringVar(&runtimeLogDir, "runtime-log-dir", "/var/lib/voiyd/containers/%s/logs", "Directory in which the runtime stores container log files in (stdout)")
...
func main() {
	...
	pflag.Usage = func() {
		...
		fmt.Fprint(os.Stderr, "  voiyd-node [OPTIONS]\n\n")
